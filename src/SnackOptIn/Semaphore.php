...
use Sta\SnackOptIn\Semaphore\Emulator;
use Sta\SnackOptIn\Semaphore\Native;
use Sta\SnackOptIn\Semaphore\SemaphoreInterface;
...
class Semaphore
{
	 ...
	 * @throws \Sta\SnackOptIn\Semaphore\Exception
